...
const ReservationParent = () => {
  ...
  useEffect(() => {
    async function getData(){
       ...
       const response = await axios.get('../reservation/parent',
       {
        headers: {
          ...
          >
            <div className="flex justify-between">
              ...
              <div className="hidden sm:flex sm:flex-col sm:items-end">
                <p className="text-lg mt-5 leading-6 font-bold text-[#ff4242]">
                  ...
                  {new Date( Creche.reservations[0].dateDebut).toISOString().substr(0, 10)}
                </p>
            ...
            <Accordion flush={true}>
              <Accordion.Panel>
                ...
                <Accordion.Content>
                  {Creche?.reservations?.map((Enfants) => (
                    <>
