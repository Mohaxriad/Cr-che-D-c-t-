...
const Choice = () => {
  return (
    <>
      <div className="Choice h-screen   text-rose-900  ">
        <h1 className="text-3xl  pt-5 text-center">Vous etes ?</h1>
        <div className="Choose mt-10 mx-0.5 sm:mx-1 ld:mx-2 flex flex-row">
          <div className="Proprio rounded-md p-5 ld:p-10 bg-[#FBEDEC] hover:scale-95 duration-300 mr-2 ring ring-[] ">
            ...
            <div className="rounded-md bg-[#f9d1d1] p-1  ld:p-5 ring ring-[]">
              <h4>
          ...
          <div className="Parent rounded-md p-10 bg-[#FBEDEC] ml-2 ring ring-[] hover:scale-95 duration-300 ">
            ...
            <div className="ring ring-[] rounded-md bg-[#f9d1d1] p-1  ld:p-5">
              <h4>
