        ...
        <>
          <div className="mx-auto max-w-7xl px-2 ld:px-8 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <Dropdown class="text-white bg-[#ec7777]  font-medium rounded-xl text-sm   ring-2 ring-[#bb3636] " 
              label={<div className=" hidden md:block h-5 w-6">
                <BellIcon/></div>} dismissOnClick={false}>
              <Dropdown.Item>
                <a
