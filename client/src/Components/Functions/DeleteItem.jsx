...
const DeleteItem = () => {
  return (
    ...
    <div className="  mx-auto max-w-[300px] ld:max-w-[500px]">
            <div className="">
              <div className="bg-[#7b0d0ddc] flex flex-col mx-[5%]  ring-4  rounded-lg p-10 mt-[50px]">
              ...
              Etes vous sur de vouloir supprimer cet item ?
                ...
                <div className="mt-6 flex flex-col items-center justify-center gap-x-6">
                 <div className=" text-[#2b8a24] text-3xl mb-5 ring-[#ea1d1d] ring rounded-full"> <RiErrorWarningFill/></div>
                 <button
                    type="submit"
