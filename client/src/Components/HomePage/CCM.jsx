  ...
  return (
    < >
      ...
      <div className="w-full z-50 -mt-6 py-[6rem] px-4 bg-[#5B112B] ">
        ...
        <div className="py-[4rem] max-w-[1240px] mx-auto grid lg:grid-cols-3 gap-10">
          <div className="bg-[#F6C9C7] w-full shadow-xl flex flex-col p-4 my-4 rounded-3xl hover:bg-blue-950 hover:text-white hover:scale-105 duration-300">
            ...
            <p className="text-center text-xl py-4 mx-2 ld:mx-8 ">
        ...
        <div>
          <p className="mt-6 text-center text-white font-medium  text-base md:text-xl ">
