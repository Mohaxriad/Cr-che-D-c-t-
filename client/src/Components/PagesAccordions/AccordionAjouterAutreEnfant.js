...
function AccordionAjouterAutreEnfant({onDataChange,NumEnfant}) {
  const inc = NumEnfant+1;
...
{/*       
      <div className="grid md:grid-cols-2 md:gap-6">  <div id="select">
          ...
          <Select options={options1} />
            ...
            <AccordionAjouterAutreEnfant onDataChange={onDataChange} NumEnfant={inc}></AccordionAjouterAutreEnfant>
          </div>
            </>, isOpen: false },
