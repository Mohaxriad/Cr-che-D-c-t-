...
import NwAccReservation from "../Prise RDV/TypeRDV/NewAccRDV";
import ReservationLoggedIN from "./TypeReservation/ReservationLoggedIN";
import Navbar from "../../Navigation/Navbar";
import Footer from "../../HomePage/Footer";
import ExistAccReservation from "./TypeReservation/ExistAccReservation";
    ...
    <>
      ...
      <div className="ring-4 rounded-xl ring-[#fc8280] mx-[1%] my-10 bg-rose-100 p-5 ld:mx-[10%]">
        <div className="flex justify-center">
          {" "}
          <h1 className="text-3xl font-semibold font-[Inter] tracking-tight text-blue-950 sm:text-4xl">
            {props.name}
          </h1>
        </div>
                ...
                <dd className="mt-1 text-md leading-6 text-blue-950 font-bold sm:col-span-2 sm:mt-0">
                  <ul className="flex flex-row">
                    ...
                    <div className="ml-3 font-medium">
                      <li>
                        {props.hdim1} - {props.hdim2}{" "}
                      </li>
                      <li>
                        {props.hlun1} - {props.hlun2}{" "}
                      </li>
                      <li>
                        {props.hmar1} - {props.hmar2}{" "}
                      </li>
                      <li>
                        {props.hmer1} - {props.hmer2}{" "}
                      </li>
                      <li>
                        {props.hjeu1} - {props.hjeu2}{" "}
                      </li>
                      <li>
                        {props.hven1} - {props.hven2}{" "}
                      </li>
                      <li>
                        {props.hsam1} - {props.hsam2}{" "}
                      </li>
                    </div>
                  </ul>
                </dd>
...
return (
   ...
   {/* Fin Images des creches*/}
      ...
      <div ref={reservationRef} id="Reservation" >
    
    <div id='Reservation' className="   z-0 mx-0.5 sm:mx-[4%] ld:mx-[10%] mb-6 group  ">
    
        <AccordionReservation id={props.id} proprio={props.Idproprio}/>
        </div>
