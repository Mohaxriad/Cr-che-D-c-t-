...
export default function Step1Connexion({onDataChange,pass}) {
                ...
                <form class="space-y-4 md:space-y-6" >
                  <div>
                    ...
                    <input
                      ...
                      name="email"
                      id="email"
                      onChange={(e) => {setEmail(e.target.value);onDataChange('email',e.target.value);}} 
                      value={email}
                      required
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="bg-gray-50 ring ring-[#f67261] shadow-[-4.09869px_3.27895px_3px_rgba(0,0,0,0.25)]  sm:text-sm  rounded-xl block w-full p-2.5 "
                      onChange={(e) => {setPassword(e.target.value);onDataChange('password',e.target.value);}} 
                      value={password}
                      required
                    />
                  </div>
