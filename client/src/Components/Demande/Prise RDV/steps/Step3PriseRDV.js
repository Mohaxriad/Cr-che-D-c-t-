...
export default function Details({onDataChange}) {
  ...
  return (<>
          ...
          <h2 className="ld:text-xl text-lg text-blue-950 font-semibold mb-10">Choisissez une date et une heure pour votre rendez vous</h2>
       ...
       <div className='mr-2' >
              ...
              <div className=" ring-red-400 rounded-md mt-2 hover:cursor-pointer ">
                <input
                  ...
                  type="time" name="heure" id="start-time" required
